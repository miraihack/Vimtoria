...
let g:vimtoria_data_tech.techs = {
      \ 'crop_rotation': {
      \   'name': '輪作', 'cost': 100.0, 'req': [],
      \   'desc': '農場(穀物・綿花)の産出 +20%',
      \   'effects': {'out': {'grain_farm': 1.2, 'cotton_farm': 1.2}}},
      \ 'steam_engine': {
      \   'name': '蒸気機関', 'cost': 150.0, 'req': [],
      \   'desc': '鉱山(石炭・鉄)の産出 +25%',
      \   'effects': {'out': {'coal_mine': 1.25, 'iron_mine': 1.25}}},
      \ 'machine_tools': {
      \   'name': '工作機械', 'cost': 200.0, 'req': ['steam_engine'],
      \   'desc': '工具工房の産出 +30%',
      \   'effects': {'out': {'tool_workshop': 1.3}}},
      \ 'power_looms': {
      \   'name': '力織機', 'cost': 250.0, 'req': ['steam_engine'],
      \   'desc': '織物工場の産出 +40%',
      \   'effects': {'out': {'textile_mill': 1.4}}},
      \ 'bessemer_process': {
      \   'name': '転炉製鋼', 'cost': 300.0, 'req': ['steam_engine'],
      \   'desc': '製鉄所の産出 +50%',
      \   'effects': {'out': {'steel_mill': 1.5}}},
      \ 'mechanized_farming': {
      \   'name': '農業機械化', 'cost': 300.0, 'req': ['crop_rotation', 'machine_tools'],
      \   'desc': '農場の産出をさらに +30%',
      \   'effects': {'out': {'grain_farm': 1.3, 'cotton_farm': 1.3}}},
      \ 'railways': {
      \   'name': '鉄道', 'cost': 350.0, 'req': ['steam_engine'],
      \   'desc': '建設力 +50%。鉄道網が石炭を毎週消費する',
      \   'effects': {'build_cap': 1.5, 'rail': 1}},
      \ 'joint_stock': {
      \   'name': '株式会社', 'cost': 250.0, 'req': [],
      \   'desc': '建設力 +25%',
      \   'effects': {'build_cap': 1.25}},
      \ 'public_schools': {
      \   'name': '公教育', 'cost': 200.0, 'req': [],
      \   'desc': '研究力 +25%',
      \   'effects': {'research': 1.25}},
      \ 'central_banking': {
      \   'name': '中央銀行', 'cost': 300.0, 'req': ['joint_stock'],
      \   'desc': '国債の年利 5% → 3%',
