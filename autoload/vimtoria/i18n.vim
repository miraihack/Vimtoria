...
let s:T = {
      ...
      \ 'hint_military': [' r/d:陸軍を徴募/解散(±5連隊) R/D:艦艇を建造/退役(±2隻) Space:停止/再開 q:マップへ戻る',
      \   ' r/d:recruit/disband army (±5) R/D:build/scrap ships (±2) Space:pause q:back to map'],
      \ 'hint_select': [' j/k・カーソル移動・クリック:国を選ぶ Enter:カーソルの国でプレイ開始 q:終了',
      \   ' j/k, cursor keys or click:choose country Enter:play the country under the cursor q:quit'],
      ...
      \ 'ml_title': ['  ━━ 軍事: %s ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
      \             '  ━━ Military: %s ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'],
      \ 'ml_stats': ['  陸軍: 連隊 %.0f / 上限 %.0f ┃ 総戦力 %.0f(技術ボーナス込み)',
      \             '  Army: %.0f regiments / cap %.0f ┃ strength %.0f (incl. tech bonus)'],
      \ 'ml_navy':  ['  海軍: 艦艇 %.0f / 上限 %.0f ┃ 海軍力 %.0f(渡航上陸に必要)',
      \             '  Navy: %.0f ships / cap %.0f ┃ naval power %.0f (needed for overseas landings)'],
      \ 'ml_navy_recruit': ['  建造: %.0f隻あたり £%s(R で建造、D で退役)',
      \             '  Shipbuilding: %.0f ships cost £%s (R to build, D to scrap)'],
      \ 'ml_navy_note': ['  ※陸続きでない州へ宣戦するには、相手海軍を上回る海軍力が要る。',
      \             '  Invading a state you cannot reach by land requires naval superiority.'],
      ...
      \ 'err_navy_cap':    ['艦艇が上限に達しています(労働力を増やすと上限も増える)',
      \                    'Ship cap reached (it grows with your workforce)'],
      \ 'err_navy_none':   ['退役させる艦艇がありません', 'No ships to scrap'],
      \ 'err_navy_weak':   ['海軍力が不足しています(渡航上陸には海軍力 %.0f 以上が必要)',
      \                    'Your navy is too weak (overseas landing needs naval power %.0f+)'],
      \ 'err_isolated':    ['鎖国中のため外交できません(歴史イベントで開国するのを待て)',
      \                    'Closed to the world — diplomacy is impossible until a historical event opens the country'],
      \ 'msg_navy_built':  ['2隻の艦艇を建造しました', 'Built 2 ships'],
      \ 'msg_navy_scrapped': ['2隻の艦艇を退役させました', 'Scrapped 2 ships'],
      \
      ...
      \ 'pu_army':     ['陸軍 %.0f個連隊(戦力 %.0f)┃ 海軍 %.0f隻(%.0f)',
      \                'Army %.0f rgts (str %.0f) ┃ navy %.0f ships (%.0f)'],
      \ 'pu_isolated': ['鎖国中 — 交易・外交は不可', 'Closed country — no trade or diplomacy'],
      ...
      \
      \ 'bf_title': ['%s — 1836年の情勢', '%s — The Situation in 1836'],
      \ 'bf_gov':   ['政体: %s ┃ 参政権: %s', 'Government: %s ┃ suffrage: %s'],
      \ 'bf_pop':   ['州 %d ┃ 人口 %s ┃ 労働力 %.0f千人', 'States %d ┃ population %s ┃ workforce %.0fk'],
      \ 'bf_mil':   ['陸軍 %.0f個連隊 ┃ 海軍 %.0f隻', 'Army %.0f regiments ┃ navy %.0f ships'],
      \ 'bf_isolated': ['◆ 鎖国中 — 開国の歴史イベントまで交易・外交不可',
      \                '◆ Closed country — no trade or diplomacy until opened by history'],
      \ 'bf_dismiss': ['(何かキーを押すと閉じる)', '(press any key to dismiss)'],
      \
      \ 'evt_fmt':         ['【%s】%s%s', '[%s] %s%s'],
      \ 'log_law_enacted': ['【法律制定】%s が施行された', '[Law] %s has been enacted'],
      \ 'log_movement':    ['【社会運動】%s が起こった', '[Movement] %s has begun'],
      \ 'log_history':     ['【歴史】%s — %s', '[History] %s — %s'],
